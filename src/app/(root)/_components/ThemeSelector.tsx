...
const THEME_ICONS: Record<string, React.ReactNode> = {
  ...
  const ThemeSelector = () => {
    const theme = useCodeEditorStore((state) => state.theme); // Select `theme` from the store
    const setTheme = useCodeEditorStore((state) => state.setTheme); // Select `setTheme` function
